        ...
        <div class="sidebar-content js-simplebar simplebar-scrollable-y" data-simplebar="init">
            <div class="simplebar-wrapper" style="margin: 0px">
              ...
              c0.2,0.5,0,1.1-0.5,1.3l-9,4C10.3,20,10.1,20,10,20z"></path>
                                ...
                                <ul class="sidebar-nav">
                                    ...
                                    <li class="sidebar-item active">
                                        ...
                                        <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show"
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/dashboard-crypto">Crypto</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul id="ecommerce" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-products">
                                                    Products
                                                    <span class="badge badge-sidebar-primary">New</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-products-details">
                                                    Product Details
                                                    <span class="badge badge-sidebar-primary">New</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-orders">
                                                    Orders
                                                    <span class="badge badge-sidebar-primary">New</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-customers">Customers</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-invoice">Invoice</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ecommerce-pricing">Pricing</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#projects" data-bs-toggle="collapse"
                                            class="sidebar-link collapsed">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="layout"
                                        ...
                                        <ul id="projects" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/projects-overview">Overview</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/projects-details">Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="/chat">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-list align-middle">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="/file-manager">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="files"
                                                class="lucide lucide-files align-middle">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="/calendar">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-calendar align-middle">
                                                <path d="M8 2v4"></path>
                                                <path d="M16 2v4"></path>
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#email" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-mail align-middle">
                                        ...
                                        <ul id="email" class="sidebar-dropdown list-unstyled collapse"
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/email-details">Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#tasks" data-bs-toggle="collapse"
                                            class="sidebar-link collapsed">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="trello"
                                                class="lucide lucide-trello align-middle">
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/pages-profile">Profile</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/pages-settings">Settings</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/pages-blank">Blank Page</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#auth" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-users align-middle">
                                        ...
                                        <ul id="auth" class="sidebar-dropdown list-unstyled collapse"
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-sign-in-cover">Sign In Cover</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-sign-up">Sign Up</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-sign-up-cover">Sign Up Cover</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-reset-password">Reset Password</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-reset-password-cover">Reset Password
                                                    Cover</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-lock-screen">Lock Screen</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-lock-screen-cover">Lock Screen
                                                    Cover</a>
                                            </li>
                                            <li class="sidebar-item">
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/auth-2fa-cover">2FA Cover</a>
                                            </li>
                                            <li class="sidebar-item">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="/landing" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-layout-template align-middle">
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#docs" data-bs-toggle="collapse"
                                            class="sidebar-link collapsed">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="book-open"
                                                class="lucide lucide-book-open align-middle">
                                        ...
                                        <ul id="docs" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/docs-introduction">Introduction</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/docs-installation">Getting Started</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/docs-customization">Customization</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/docs-plugins">Plugins</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/docs-changelog">Changelog</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#ui" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="grid"
                                                class="lucide lucide-grid align-middle">
                                                <rect width="18" height="18" x="3" y="3" rx="2"></rect>
                                                <path d="M3 9h18"></path>
                                        ...
                                        <ul id="ui" class="sidebar-dropdown list-unstyled collapse"
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-embed-video">Embed Video</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-general">General
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-offcanvas">Offcanvas</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-placeholders">Placeholders</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-tabs">Tabs</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/ui-typography">Typography</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#icons" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-heart align-middle">
                                                <path
                                        ...
                                        <ul id="icons" class="sidebar-dropdown list-unstyled collapse"
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/icons-font-awesome">Font Awesome</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#forms" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-check-square align-middle">
                                        ...
                                        <ul id="forms" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-layouts">Layouts</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-basic-inputs">Basic Inputs</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-input-groups">Input Groups</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-floating-labels">Floating
                                                    Labels</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#forms-plugins" data-bs-toggle="collapse"
                                            class="sidebar-link collapsed">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <ul id="forms-plugins" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-advanced-inputs">Advanced
                                                    Inputs</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-editors">Editors</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/forms-validation">Validation</a>
                                            </li>
                                            <li class="sidebar-item">
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul id="datatables" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-responsive">Responsive
                                                    Table</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-buttons">Table with
                                                    Buttons</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-column-search">Column
                                                    Search</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-fixed-header">Fixed Header</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-multi">Multi Selection</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/datatables-ajax">Ajax Sourced Data</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#charts" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="pie-chart"
                                                class="lucide lucide-pie-chart align-middle">
                                        ...
                                        <ul id="charts" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/charts-chartjs">Chart.js</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/charts-apexcharts">ApexCharts
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="/notifications">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="bell"
                                                class="lucide lucide-bell align-middle">
                                    ...
                                    <li class="sidebar-item">
                                        <a data-bs-target="#maps" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-map-pin align-middle">
                                        ...
                                        <ul id="maps" class="sidebar-dropdown list-unstyled collapse"
                                            data-bs-parent="#sidebar">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/maps-google">Google Maps</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link" href="/maps-vector">Vector Maps</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sidebar-item">
                                        <a data-bs-target="#multi" data-bs-toggle="collapse"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round" data-lucide="share-2"
                                                class="lucide lucide-share-2 align-middle">
                ...
                <div class="simplebar-placeholder" style="width: 260px; height: 1657px"></div>
            </div>
