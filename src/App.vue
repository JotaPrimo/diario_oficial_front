<template>
  <div class="wrapper">
    <nav id="sidebar" class="sidebar">
      <div
        class="sidebar-content js-simplebar simplebar-scrollable-y"
        data-simplebar="init"
      >
        <div class="simplebar-wrapper" style="margin: 0px">
                  ...
                  <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                      ...
                      >
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/dashboard-analytics"
                            >Analytics</a
                          >
                        </li>
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/dashboard-saas"
                            >SaaS</a
                          >
                        </li>
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/dashboard-social"
                            >Social</a
                          >
                        </li>
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/dashboard-crypto"
                            >Crypto</a
                          >
                        </li>
                      </ul>
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/tasks-kanban"
                            >Kanban</a
                          >
                        </li>
                      </ul>
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        ...
                        <span class="badge badge-sidebar-secondary"
                          >Special</span
                        >
                      </a>
                      <ul
                      ...
                      >
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/auth-sign-in"
                            >Sign In</a
                          >
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/auth-sign-up"
                            >Sign Up</a
                          >
                        </li>
                        <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/docs-plugins"
                            >Plugins</a
                          >
                        </li>
                        <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/ui-carousel"
                            >Carousel</a
                          >
                        </li>
                        <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/icons-lucide"
                            >Lucide</a
                          >
                        </li>
                        <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                      ...
                      >
                        ...
                        <li class="sidebar-item">
                          <a class="sidebar-link" href="/forms-wizard"
                            >Wizard</a
                          >
                        </li>
                      </ul>
          ...
          <div
            ...
            style="width: 260px; height: 1657px"
          ></div>
        </div>
        <div
              ...
              >
                <div class="position-relative">
                  <svg
                    ...
                    class="lucide lucide-message-circle align-middle text-body"
                  >
              ...
              >
                <div class="position-relative">
                  <svg
                    ...
                    class="lucide lucide-bell-off align-middle text-body"
                  >
                    ...
                    <div class="row g-0 align-items-center">
                      <div class="col-2">
                        <svg
                          ...
                          class="lucide lucide-alert-circle text-danger"
                        >
                    ...
                    <div class="row g-0 align-items-center">
                      <div class="col-2">
                        <svg
                          ...
                          stroke-linejoin="round"
                          data-lucide="bell"
                          class="lucide lucide-bell text-warning"
                        >
                          <path
                            d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"
                          ></path>
                    ...
                    <div class="row g-0 align-items-center">
                      <div class="col-2">
                        <svg
                          ...
                          stroke-linejoin="round"
                          data-lucide="home"
                          class="lucide lucide-home text-primary"
                        >
                          <path
                    ...
                    <div class="row g-0 align-items-center">
                      <div class="col-2">
                        <svg
                          ...
                          class="lucide lucide-user-plus text-success"
                        >
                          <path
                            d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"
                          ></path>
              ...
              <a class="nav-icon js-theme-toggle" href="#">
                <div class="position-relative">
                  <svg
                    ...
                    stroke-linejoin="round"
                    data-lucide="sun"
                    class="lucide lucide-sun align-middle text-body nav-theme-toggle-light"
                  >
                  ...
                  <svg
                    ...
                    stroke-linejoin="round"
                    data-lucide="moon"
                    class="lucide lucide-moon align-middle text-body nav-theme-toggle-dark"
                  >
            ...
            <li class="nav-item dropdown">
              ...
              >
                <svg
                  ...
                  class="lucide lucide-settings align-middle"
                >
                  <path
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item" href="/pages-profile"
                  ><svg
                    ...
                    stroke-linejoin="round"
                    data-lucide="user"
                    class="lucide lucide-user align-middle me-1"
                  >
                ...
                <a class="dropdown-item" href="#"
                  ><svg
                    ...
                    stroke-linejoin="round"
                    data-lucide="pie-chart"
                    class="lucide lucide-pie-chart align-middle me-1"
                  >
                    <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                    <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
                  </svg>
            ...
            <div class="col-auto ms-auto text-end mt-n1">
              <div class="dropdown me-2 d-inline-block position-relative">
                ...
                >
                  <svg
                    ...
                    stroke-linejoin="round"
                    data-lucide="calendar"
                    class="lucide lucide-calendar align-middle mt-n1"
                  >
                    <path d="M8 2v4"></path>
                    <path d="M16 2v4"></path>
              ...
              <button class="btn btn-primary shadow-sm">
                <svg
                  ...
                  stroke-linejoin="round"
                  data-lucide="filter"
                  class="lucide lucide-filter align-middle"
                >
                  <polygon
              ...
              <button class="btn btn-primary shadow-sm">
                <svg
                  ...
                  class="lucide lucide-refresh-cw align-middle"
                >
                  <path
                ...
                <div class="card-body p-0 d-flex flex-fill">
                  <div class="row g-0 w-100">
                    ...
                    <div class="col-6 align-self-end text-end">
                      <img
                        src="img/illustrations/customer-support.png"
                    ...
                    <div class="d-inline-block ms-3">
                      <div class="stat">
                        <svg
                          ...
                          class="lucide lucide-dollar-sign align-middle text-success"
                        >
                    ...
                    <div class="d-inline-block ms-3">
                      <div class="stat">
                        <svg
                          ...
                          stroke-linejoin="round"
                          data-lucide="shopping-bag"
                          class="lucide lucide-shopping-bag align-middle text-danger"
                        >
                          <path
                            d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"
                          ></path>
                    ...
                    <div class="d-inline-block ms-3">
                      <div class="stat">
                        <svg
                          ...
                          stroke-linejoin="round"
                          data-lucide="dollar-sign"
                          class="lucide lucide-dollar-sign align-middle text-info"
                        >
                          <line x1="12" x2="12" y1="2" y2="22"></line>
                          <path
                            d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"
                ...
                <div class="card-body d-flex w-100">
                  <div class="align-self-center chart chart-lg">
                    ...
                    <canvas
                      ...
                      style="display: block; width: 994px; height: 350px"
                      width="994"
                      height="350"
                  ...
                  <div class="align-self-center w-100">
                    <div class="chart">
                      <div id="calendar-dashboard">
                        <div class="tempus-dominus-widget inline light show">
                          <div class="date-container td-collapse show" style="">
                            <div class="calendar-header">
                              ...
                              <div
                                class="picker-switch"
                                data-action="changeCalendarView"
                                date-container-days="junho de 24"
                                title="Select Month"
                              >
                                junho de 24
                              </div>
                            ...
                            <div
                              class="date-container-decades"
                              style="display: none"
                            >
                              <div data-action="selectDecade"></div>
                              <div data-action="selectDecade"></div>
                              <div data-action="selectDecade"></div>
                              <div data-action="selectDecade"></div>
                              <div data-action="selectDecade"></div>
                            ...
                            <div
                              class="date-container-years"
                              style="display: none"
                            >
                              <div data-action="selectYear"></div>
                              <div data-action="selectYear"></div>
                              <div data-action="selectYear"></div>
                              <div data-action="selectYear"></div>
                              <div data-action="selectYear"></div>
                            ...
                            <div
                              class="date-container-months"
                              style="display: none"
                            >
                              <div data-action="selectMonth"></div>
                              <div data-action="selectMonth"></div>
                              <div data-action="selectMonth"></div>
                              <div data-action="selectMonth"></div>
                              <div data-action="selectMonth"></div>
                            ...
                            <div
                              class="date-container-days"
                              style="display: grid"
                            >
                              <div class="dow no-highlight">dom.</div>
                              <div class="dow no-highlight">seg.</div>
                              <div class="dow no-highlight">ter.</div>
                              <div class="dow no-highlight">qua.</div>
                              <div class="dow no-highlight">qui.</div>
                              <div class="dow no-highlight">sex.</div>
                              <div class="dow no-highlight">sáb.</div>
                              <div
                                data-action="selectDay"
                                class="day old weekend"
                                data-value="2024-04-26"
                                data-day="26"
                              >
                                26
                              </div>
                    ...
                    <div class="py-3">
                      <div class="chart chart-xs">
                        ...
                        <canvas
                          ...
                          style="display: block; width: 465px; height: 150px"
                          width="465"
                          height="150"
                          class="chartjs-render-monitor"
                        ></canvas>
                ...
                <div class="card-body">
                  <ul class="timeline">
                    ...
                    <li class="timeline-item">
                      ...
                      <p>
                        Sed aliquam ultrices mauris. Integer ante arcu, accumsan
                        a, consectetuer eget, posuere ut, mauris. Praesent
